...
import { ComboList, MenuSearch, UserAuthApi, UserDetails } from '../apis/student-api';
import { Linking } from 'react-native';

export default function AllComboScreen() {
                    ...
                    <View style={{ width: "83%", borderRadius: 50 }} className="flex-row space-x-2 items-center p-3 border border-gray-800">
                        ...
                        <View className="flex-1">
                            <View className="flex-row items-center space-x-1 border-0 border-l-2 pl-2 border-l-gray-500">
                                ...
                                <ScrollView horizontal={true}  showsHorizonmaptalScrollIndicator={false}>
                ...
                >
                    {
                        ...
                        combos.map(combo => {
                            return (
                                <FeaturedTitle key={combo._id} menu={combo} combo={true} cart={cart} user_id={user?.id} refresh={refresh} setRefresh={setRefresh}/>
                            )
                        })
                        :
                        <View className="items-center bg-white py-40">
                            <Icon.XCircle height="100" width="100" strokeWidth={2} stroke="#b0aeae"/>
                            <Text style={{ fontWeight: '900', color:'#b0aeae' }} className="text-xl">No Combos</Text>
                        </View>
                    }
